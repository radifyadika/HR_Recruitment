...
The dataset used was sourced from Kaggle: [ML for HR: Employee Recruitment Modeling]([https://www.kaggle.com](https://www.kaggle.com/datasets/rabieelkharoua/predicting-hiring-decisions-in-recruitment-data?utm_source=chatgpt.com))  
